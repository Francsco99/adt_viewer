...
export function defineRoutes(router: IRouter) {
  ...
  router.get(
    ...
    async (context, request, response) => {
      try {
        const flaskResponse = await fetch('http://database:5003/api/trees', {
          method: 'GET',
        });
  ...
  router.get(
    ...
    async (context, request, response) => {
      ...
      try {
        const flaskResponse = await fetch(`http://database:5003/api/trees/${treeId}`, {
          method: 'GET',
        });
  ...
  router.get(
    ...
    async (context, request, response) => {
      try {
        const flaskResponse = await fetch('http://database:5003/api/policies', {
          method: 'GET',
        });
  ...
  router.get(
    ...
    async (context, request, response) => {
      ...
      try {
        const flaskResponse = await fetch(`http://database:5003/api/policies/${policyId}`, {
          method: 'GET',
        });
